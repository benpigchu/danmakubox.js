(function (global, factory) {
  ...
  (factory((global.DanmakuBox = global.DanmakuBox || {})));
...
module.exports=_dereq_(22)('Map',function(get$$1){return function Map(){return get$$1(this,arguments.length>0?arguments[0]:undefined);};},{// 23.1.3.6 Map.prototype.get(key)
...
module.exports=_dereq_(22)('Set',function(get$$1){return function Set(){return get$$1(this,arguments.length>0?arguments[0]:undefined);};},{// 23.2.3.1 Set.prototype.add(value)
...
_dereq_(22)('WeakSet',function(get$$1){return function WeakSet(){return get$$1(this,arguments.length>0?arguments[0]:undefined);};},{// 23.4.3.1 WeakSet.prototype.add(value)
...
var Danmaku = function () {
	function Danmaku(renderer, content) {
		classCallCheck(this, Danmaku);
		...
		var textMeasure = this.renderer.canvas.measureText(this.content);
...
/// the renderer class
var DanmakuRenderer = function () {
	function DanmakuRenderer(canvas) {
		...
		var time = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 15000;
		var strokeColor = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "#cccccc";
		classCallCheck(this, DanmakuRenderer);
	...
	createClass(DanmakuRenderer, [{
		...
		key: "startAutoRender",
		value: function startAutoRender() {
		...
		value: function render() {
			...
			try {
				for (var _iterator = this.danmakuPool[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var danmaku = _step.value;
		...
		value: function update() {
			...
			if (this.isRunning && currentTime - this.timeStamp > 0) {
				...
				try {
					for (var _iterator2 = this.danmakuPool[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
		...
		key: "_getLimit",
		value: function _getLimit(height, time) {
			var limitList = [];
			...
			try {
				for (var _iterator3 = this.danmakuPool[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
